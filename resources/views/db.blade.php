    ...
    <style>
        ...
        */
        ...
        .NiMH:after {
            ...
            background-color: rgba(0, 170, 0, .35);
            /*(only dealer)*/
        ...
        @include('layouts/jsCss') @yield('css')
    </style>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <style>
        table {
...
<body>
  ...
  flex-direction: row;" class="">
        ...
        <input type="radio" class="cath_6" id="r5" name="r">
        <abel for="r5">60%</abel>
        <input type="radio" class="cath_8" id="r6" name="r">
        <llabel for="r6">80%</llabel>
